...
Every new agent **MUST** be added to `~/.claude/agents/frontal-lobe.md` in the Available Agents table. If the agent is not listed, frontal-lobe cannot invoke it.
...
```bash
scripts/convert.sh --to-opencode    # After editing claude-code/ configs
