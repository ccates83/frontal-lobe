...
1. Read at least 2 existing examples of the artifact type you're creating from `~/.claude/agents/`, `~/.claude/skills/*/SKILL.md`, or `~/.claude/commands/`
...
4. Read `~/.claude/agents/frontal-lobe.md` if you need to update the routing table
...
**File**: `~/.claude/skills/{skill-name}/SKILL.md` (must be in subdirectory)
