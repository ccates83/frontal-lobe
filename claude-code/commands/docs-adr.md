...
argument-hint: "The decision to document (e.g., 'chose PostgreSQL over MongoDB for user data', 'adopted event sourcing for order processing')"
---
...
1. Launch `docs-writer` with specific fixes
2. Maximum 2 rounds
