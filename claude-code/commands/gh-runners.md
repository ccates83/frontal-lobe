---
description: Manage and troubleshoot GitHub Actions runners
argument-hint: "Action to take (e.g., 'list', 'status', 'debug offline runner', 'setup self-hosted', 'configure ARC')"
---
...
1. Read CLAUDE.md for runner-specific conventions
