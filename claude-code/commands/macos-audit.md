---
description: Audit a macOS project for health, best practices, and common issues
argument-hint: Optional focus area (e.g., "sandbox", "distribution", "architecture", "concurrency")
---
