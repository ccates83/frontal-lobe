...
argument-hint: "What to refactor (e.g., 'migrate to async SQLAlchemy', 'extract service layer from views')"
---
...
## Phase 2: Plan
Launch `python-architect` with refactoring goal and current patterns.

## Phase 3: Implement
Launch `python-builder` with step-by-step instructions from the architect.
