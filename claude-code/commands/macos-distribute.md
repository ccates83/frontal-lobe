---
description: Build, sign, notarize, and package a macOS app for distribution
argument-hint: "dmg" or "pkg" or "app-store" (default: dmg)
---
...
1. Read CLAUDE.md for project-specific distribution commands, signing identity, and team ID
