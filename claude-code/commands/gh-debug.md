---
description: Debug a failed GitHub Actions workflow run
argument-hint: "Run ID, PR number, or workflow name (e.g., '12345678', '#42', 'ci.yml')"
---
...
1. Read CLAUDE.md for project-specific CI/CD context
