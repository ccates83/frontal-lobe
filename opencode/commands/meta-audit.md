...
2. List all agents in `~/.config/opencode/agents/`
3. List all skills in `~/.config/opencode/skills/`
4. List all commands in `~/.config/opencode/commands/`
5. Read `~/.config/opencode/agents/frontal-lobe.md` for the routing table
