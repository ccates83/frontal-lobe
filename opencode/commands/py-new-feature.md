...
Use the task tool to invoke `@python-architect` with feature description and project context.

## Phase 3: Implement
Use the task tool to invoke `@python-builder` with the architect's blueprint.

## Phase 4: Test
Use the task tool to invoke `@python-tester` with instructions to write tests for the new feature.

## Phase 5: Review
Use the task tool to invoke `@python-reviewer` with all new/modified files.
