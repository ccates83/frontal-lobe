...
```bash
ls -la ~/.cursor/agents/*.md | wc -l
ls -la ~/.cursor/skills/
ls -la ~/.cursor/commands/*.md | wc -l
```

Read `~/.cursor/agents/frontal-lobe.md` to understand the routing table.
...
#### Skill Files
- [ ] Located in `~/.cursor/skills/{name}/SKILL.md` (proper subdirectory)
