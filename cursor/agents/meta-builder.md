...
1. Read at least 2 existing examples of the artifact type you're creating from `~/.cursor/agents/`, `~/.cursor/skills/*/SKILL.md`, or `~/.cursor/commands/`
...
4. Read `~/.cursor/agents/frontal-lobe.md` if you need to update the routing table
...
**File**: `~/.cursor/skills/{skill-name}/SKILL.md` (must be in subdirectory)
