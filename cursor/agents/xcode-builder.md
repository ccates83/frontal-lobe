...
4. Read project guidance (CLAUDE.md or project guidance (CLAUDE.md or AGENTS.md)) for project-specific build commands
...
1. Detect project type and read project guidance (CLAUDE.md or project guidance (CLAUDE.md or AGENTS.md)) for build commands
