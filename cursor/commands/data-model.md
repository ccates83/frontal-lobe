...
1. Read project guidance (CLAUDE.md or project guidance (CLAUDE.md or AGENTS.md)), scan for database files
...
## Phase 2: Design
Delegate to the `data-architect` subagent with the modeling request and current schema context.

## Phase 3: Implement
Delegate to the `data-builder` subagent with the architect's schema design and migration plan.

## Phase 4: Review
Delegate to the `data-reviewer` subagent with the new schema and migration files.
