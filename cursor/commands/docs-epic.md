...
1. Read project guidance (CLAUDE.md or project guidance (CLAUDE.md or AGENTS.md)) for project conventions and architecture
...
Delegate to the `docs-planner` subagent with:
...
Delegate to the `docs-reviewer` subagent with:
- The epic document
...
1. Delegate to the `docs-planner` subagent with specific fixes
2. Maximum 2 rounds
