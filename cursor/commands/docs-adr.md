...
1. Read project guidance (CLAUDE.md or project guidance (CLAUDE.md or AGENTS.md)) for project architecture and conventions
...
Delegate to the `docs-writer` subagent with:
...
1. Delegate to the `docs-writer` subagent with specific fixes
2. Maximum 2 rounds
